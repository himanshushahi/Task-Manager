...
function HomePage() {
  return (
    <div>
      {/* Hero Section */}
      <div className="bg-teal-600 text-white w-full py-8 sm:py-10 md:py-12 lg:py-16">
      ...
      <div className="py-10 bg-gray-100">
        <div className="w-full md:w-[80%] lg:w-[80%] mx-auto text-center px-2 lg:px-0">
          <h2 className="lg:text-3xl md:tex-2xl text-xl font-bold mb-8 text-teal-600">
            Our Services
          </h2>
      ...
      <div className="py-10 bg-gray-100">
        <div className="w-full md:w-[80%] lg:w-[80%] mx-auto px-2 lg:px-0">
          <h2 className="lg:text-3xl md:text-2xl text-xl text-center font-bold mb-8 text-teal-600">
